...
class POS_manager:
    ...
    def match_sentence(self, sentence: list[str]) -> tuple[list[str], list[float]] | None:
        ...
        def calculate_path_between(current_tag: str, cur_distance: int, target_tag: str, tgt_distance: int) -> tuple[tuple[str, ...], tuple[float|int, ...]]:
            ...
            while len(heap) > 0:
                ...
                match cur_distance:
                    ...
                    case tgt_distance:
                        ...
                        if path_list[-1].value == target_tag:
            ...
            return (self.end_token, ) * (tgt_distance - cur_distance), (-1, ) * (tgt_distance - cur_distance)
